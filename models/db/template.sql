...
--
-- Table structure for table `casas_categorias`
--

DROP TABLE IF EXISTS `casas_categorias`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `casas_categorias` (
...
--
-- Dumping data for table `casas_categorias`
--

LOCK TABLES `casas_categorias` WRITE;
/*!40000 ALTER TABLE `casas_categorias` DISABLE KEYS */;
%data-casas-categorias%
/*!40000 ALTER TABLE `casas_categorias` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `clientes` (
  ...
  `codigo_sector` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`cedula`)
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-03-15 15:55:14
